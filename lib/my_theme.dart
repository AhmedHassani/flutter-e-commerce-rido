...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(253, 205, 1,1);
  static Color accent_color_shadow = Color.fromRGBO(
      255, 209, 7, 0.8235294117647058); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(254,234,209, 1);
  static Color splash_screen_color = Color.fromRGBO(253, 205, 1,1); // if not sure , use the same color as accent color
  ...
  static Color activeBottomNavigationBarColor = Color.fromRGBO(234,67,53, 1);

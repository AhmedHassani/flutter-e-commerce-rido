...
import 'package:rido/data_model/common_response.dart';
import 'package:rido/data_model/purchased_ditital_product_response.dart';
import 'package:http/http.dart' as http;
import 'package:rido/data_model/product_mini_response.dart';
import 'package:rido/data_model/product_details_response.dart';
import 'package:rido/data_model/variant_response.dart';
...
class ProductRepository {
  ...
  String  productsURl= access_token.$.isEmpty? "${AppConfig.BASE_URL}/products/search" +
    "?page=${page}&name=${name}&sort_key=${sort_key}"
    "&brands=${brands}&categories=${categories}&min=${min}&max=${max}" : "${AppConfig.BASE_URL}/products/search-for-user" +
    "?page=${page}&name=${name}&sort_key=${sort_key}"
    "&brands=${brands}&categories=${categories}&min=${min}&max=${max}";

...
import 'package:rido/screens/order_details.dart';
import 'package:rido/screens/main.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:rido/my_theme.dart';
import 'package:flutter_icons/flutter_icons.dart';
import 'package:rido/repositories/order_repository.dart';
...
class PaymentStatus {
  ...
  static List<PaymentStatus> getPaymentStatusList(context) {
    return <PaymentStatus>[
      PaymentStatus('', AppLocalizations.of(OneContext().context).order_list_screen_all_payments),
      PaymentStatus(AppLocalizations.of(context).order_list_screen_paid, AppLocalizations.of(OneContext().context).order_list_screen_paid),
      PaymentStatus(AppLocalizations.of(context).order_list_screen_unpaid, AppLocalizations.of(OneContext().context).order_list_screen_unpaid),
    ];
  }
}
...
class _OrderListState extends State<OrderList> {
  ...
  List<PaymentStatus> _paymentStatusList = PaymentStatus.getPaymentStatusList(OneContext().context);

...
import 'package:rido/custom/box_decorations.dart';
import 'package:rido/custom/device_info.dart';
import 'package:rido/custom/lang_text.dart';
import 'package:rido/helpers/auth_helper.dart';
import 'package:rido/screens/auction_products.dart';
import 'package:rido/screens/change_language.dart';
import 'package:rido/screens/classified_ads/classified_ads.dart';
import 'package:rido/screens/classified_ads/my_classified_ads.dart';
import 'package:rido/screens/contact_us.dart';
import 'package:rido/screens/digital_product/digital_products.dart';
import 'package:rido/screens/digital_product/purchased_digital_produts.dart';
import 'package:rido/screens/filter.dart';
import 'package:rido/screens/login.dart';
import 'package:rido/screens/main.dart';
import 'package:rido/screens/messenger_list.dart';
import 'package:rido/screens/whole_sale_products.dart';
import 'package:rido/screens/wishlist.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:rido/my_theme.dart';
import 'package:rido/ui_sections/drawer.dart';
...
import 'package:rido/screens/profile_edit.dart';
import 'package:rido/screens/address.dart';
import 'package:rido/screens/order_list.dart';
import 'package:rido/screens/club_point.dart';
import 'package:rido/screens/refund_request.dart';
import 'package:rido/repositories/profile_repository.dart';
      ...
      child: Column(
        children: [
          ...
          buildBottomVerticalCardListItem("assets/shop.png",
              LangText(context).local.filter_screen_sellers,
              onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) {
              return Filter(
...
/*
  ...
  Container buildSettingAndAddonsHorizontalMenuItem(
      String img, String text, Function() onTap,{needLogin = true}) {
    return Container(
      alignment: Alignment.center,
      // color: Colors.red,
      // width: DeviceInfo(context).width / 4,
      child: InkWell(
        onTap: needLogin ? is_logged_in.$
            ? onTap
            : () {
                showLoginWarning();
              } : onTap,
        child: Column(
          ...
          children: [
            Image.asset(
              ...
              width: 16,
              height: 16,
              color:needLogin? is_logged_in.$
                  ? MyTheme.dark_font_grey
                  : MyTheme.medium_grey_50 :  MyTheme.dark_font_grey,
            ),
            SizedBox(
              height: 10,
            ),

...
import 'package:rido/data_model/user_info_response.dart';
...
import 'package:rido/screens/package/packages.dart';
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: CommonFunctions.dashboardBoxText(context).copyWith(color: MyTheme.accent_color,fontSize: 12),
                    ),

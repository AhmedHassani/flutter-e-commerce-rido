...
import 'package:rido/presenter/bottom_appbar_index.dart';
...
import 'package:rido/screens/home.dart';
import 'package:rido/screens/login.dart';
import 'package:rido/screens/profile.dart';
...
class _MainState extends State<Main> {
  ...
  void onTapped(int i) {
    ...
    if(i== 2){
      app_language_rtl.$ ?slideLeftWidget(newPage: Filter(
        selected_filter: "sellers",
      ), context: context):slideRightWidget(newPage: Filter(
        selected_filter: "sellers",
      ), context: context);
      return;
    }
        ...
        child: Scaffold(
          ...
          SizedBox(
            ...
            child: BottomNavigationBar(
              ...
              selectedItemColor: MyTheme.activeBottomNavigationBarColor,
              ...
              items: [
                    ...
                    icon: Padding(
                      ...
                      child: Image.asset(
                        ...
                        color: _currentIndex == 0
                            ? MyTheme.activeBottomNavigationBarColor
                ...
                BottomNavigationBarItem(
                    ...
                    label: AppLocalizations.of(context)
                        .main_screen_bottom_navigation_seller),
                BottomNavigationBarItem(
                    icon: Padding(
                      padding: const EdgeInsets.only(bottom: 8.0),
                      child:
                      Badge(
                        ...
                        badgeColor: MyTheme.activeBottomNavigationBarColor,

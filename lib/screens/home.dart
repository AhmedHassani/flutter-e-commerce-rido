import 'package:rido/custom/common_functions.dart';
...
import 'package:rido/screens/flash_deal_list.dart';
import 'package:rido/screens/todays_deal_products.dart';
import 'package:rido/screens/top_selling_products.dart';
import 'package:rido/screens/category_products.dart';
import 'package:rido/screens/category_list.dart';
import 'package:rido/ui_sections/drawer.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:rido/repositories/sliders_repository.dart';
import 'package:rido/repositories/category_repository.dart';
  ...
  AppBar buildAppBar(double statusBarHeight, BuildContext context) {
    return AppBar(
      ...
      flexibleSpace: Padding(
          ...
          padding:
          const EdgeInsets.only(top: 12.0, bottom: 12, left: 18, right: 18),
          child: GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) {
                  return Filter();
        ...
        child: Row(
          ...
          children: [
            Text(
              ...
              style: TextStyle(fontSize: 17.0, color: MyTheme.textfield_grey),
            ),
            Image.asset(
              'assets/search.png',
              height: 16,

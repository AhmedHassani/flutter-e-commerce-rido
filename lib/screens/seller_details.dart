...
import 'package:rido/custom/useful_elements.dart';
import 'package:rido/repositories/follow_repository.dart';
import 'package:rido/repositories/product_repository.dart';
import 'package:rido/screens/seller_products.dart';
...
import 'package:rido/ui_elements/list_product_card.dart';
import 'package:rido/ui_elements/mini_product_card.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:rido/repositories/shop_repository.dart';
...
class _SellerDetailsState extends State<SellerDetails> {
  ...
  var follow;
  var isFollowResponse;
  @override
  void initState() {
    fetchAll();

    // print('isFollowResponse $isFollowResponse');
  ...
  fetchShopDetails() async {
    ...
    if (shopDetailsResponse.shop != null) {
      print('shopDetails ${shopDetailsResponse.shop.id}');
      print('iiiiiddd ${widget.id}');
    ...
    _carouselInit = true;
    FollowRepository().isFollow(sellerId: _shopDetails.user_id).then((value) {
      follow = value.result;
      print('isfllllow $follow');
    });
    setState(() {});
  }
  ...
  Widget buildFeaturedProductsSection() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Padding(
            padding: EdgeInsetsDirectional.only(start: 18.0, top: 20),
            child: Text(
            ...
            follow != null
                ? Visibility(
                    ...
                    child: Container(
                      ...
                      child: FlatButton(
                        padding: EdgeInsets.zero,
                        color: follow ? MyTheme.light_grey : MyTheme.amber,
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(6),
                        ...
                        onPressed: () async {
                          ...
                          if (follow == false) {
                            ...
                            response = await FollowRepository()
                                .follow(sellerId: _shopDetails.user_id)
                                .then((value) {


                              FollowRepository()
                                  .isFollow(sellerId: _shopDetails.user_id)
                                  .then((value) {
                                print('valfollowuefafadf ${value.result}');
                            ...
                            response = await FollowRepository()
                                .unFollow(sellerId:  _shopDetails.user_id)
                                .then((value) {

                              FollowRepository()
                                  .isFollow(sellerId: widget.id)
                                  .then((value) {
                                follow = value.result;
                              });
                        ...
                        child: Text(
                          follow
                              ...
                              :  AppLocalizations.of(context).common_follow,
                          style: TextStyle(
                              fontSize: 10,
                              color:
                                  follow ? MyTheme.dark_grey : MyTheme.golden),
                        ),
                      ),
                    ),
                  )
